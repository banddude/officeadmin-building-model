"""PDF page display-space coordinate normalization helpers.

The electrical extractor uses pypdf visitor callbacks, which report coordinates
in PDF user space and do not apply the page /Rotate entry. Downstream electrical
recognition assumes the orientation a viewer displays, so extraction normalizes
all source positions before creating observations.
"""
